...
python main.py --config configs/revani.yaml mesh=data/dragon.glb camera_path=side prompt="a red pet dragon with fire patterns" save_path=dragon_fire.obj text_dir=True 
python main.py --config configs/revani.yaml mesh=data/dragon.glb camera_path=side prompt="a green pet dragon with grass patterns" save_path=dragon_grass.obj text_dir=True 
python main.py --config configs/revani.yaml mesh=data/dragon.glb camera_path=side prompt="a blue pet dragon with ice patterns" save_path=dragon_ice.obj text_dir=True 
python main.py --config configs/revani.yaml mesh=data/dragon.glb camera_path=side prompt="a pink dragon with cherry patterns" save_path=dragon_cherry.obj text_dir=True 
python main.py --config configs/revani.yaml mesh=data/dragon.glb camera_path=side prompt="a robotic dragon with gear and screw patterns" save_path=dragon_robot.obj text_dir=True 
python main.py --config configs/revani.yaml mesh=data/dragon.glb camera_path=side prompt="a colorful dragon with rainbow patterns" save_path=dragon_rainbow.obj text_dir=True 
...
python main.py --config configs/revani.yaml mesh=data2/catpet.obj camera_path=side prompt="a colorful cat with rainbow patterns" save_path=cat_rainbow.obj text_dir=True 
...
python main.py --config configs/revani.yaml mesh=data2/foxpet.obj camera_path=side prompt="a colorful fox with rainbow patterns" save_path=fox_rainbow.obj text_dir=True 