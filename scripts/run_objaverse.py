...
for uid in uids:
    ...
    os.system(f'CUDA_VISIBLE_DEVICES={args.gpu} python main.py --config configs/revani.yaml mesh={uid} prompt="{prompt}" save_path={uid}.obj retex=True')
    os.system(f"python -m kiui.render logs/{uid}.obj --wogui --save_video videos/{uid}.mp4 --radius 2")